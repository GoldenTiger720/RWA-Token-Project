            ...
            <div className="row">
              <div className="col-12 col-sm-9 col-md-8 col-xl-7">
                <h1 className="animate a_01">
                  This is our first project based on <span className="animate a_02">RWA</span> tokenization.
                </h1>
              ...
              <div className="col-12 col-lg-4 d-flex">
                <article>
                  ...
                  <div className="item-body">
                    <p>
                      RWA tokenization bridges the gap between traditional finance and blockchain, simplifying ownership
